...
function getWeather(city) {
    fetch(`https://api.weatherapi.com/v1/forecast.json?key=f030cb6a5047432399f111440250106&q=${city}&days=14&aqi=no&alerts=no`)
        .then(res => res.json())
        .then(d => {
            console.log(d)
            data = d
...
document.querySelector(`#search`).addEventListener("input", (e) => {
    console.log(e.target.value)
    fetch(`https://api.weatherapi.com/v1/search.json?key=f030cb6a5047432399f111440250106&q=${e.target.value}`).then(res => res.json()).then(data => {
